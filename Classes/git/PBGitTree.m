...
- (BOOL)hasBinaryHeader:(NSString *)contents
{
	...
	return [contents rangeOfString:@"\0"
						   options:0
							 range:NSMakeRange(0, ([contents length] >= 8000) ? 7999 : [contents length])]
			   .location != NSNotFound;
}
...
- (NSArray *)children
{
	...
	BOOL success = [actualTree enumerateEntriesWithOptions:GTTreeEnumerationOptionPre
													 error:&error
													 block:^BOOL(GTTreeEntry *_Nonnull entry, NSString *_Nonnull root, BOOL *_Nonnull stop) {
