...
- (void)addCommitsFromEnumerator:(GTEnumerator *)enumerator operation:(NSOperation *)operation
{
	...
	dispatch_queue_t loadQueue = dispatch_queue_create("com.themacronaut.net.phere.GitX.loadQueue", 0);
	dispatch_queue_t decorateQueue = dispatch_queue_create("com.themacronaut.net.phere.GitX.decorateQueue", 0);
